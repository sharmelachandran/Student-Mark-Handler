...
public class SEMFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_sem, container, false);
        regno=(EditText)v.findViewById(R.id.editText25);
        btn=(Button)v.findViewById(R.id.button13);
        ass1=(TextView)v.findViewById(R.id.textView18);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    ref = database.getReference().child("Courses").child(id).child("SEM");
