...
public class ParentRegActivity extends AppCompatActivity {
    EditText name,id,phone,mail,pass;
    TextView tv;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phone=(EditText)findViewById(R.id.editText17);
        mail=(EditText)findViewById(R.id.editText16);
        pass=(EditText)findViewById(R.id.editText18);
        tv=(TextView)findViewById(R.id.textView7);
        btn=(Button)findViewById(R.id.button7);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String _name, _id, _phn, _mail, _pass;
                ...
                if (TextUtils.isEmpty(id.getText().toString().trim()) &&
                        ...
                        && TextUtils.isEmpty(phone.getText().toString().trim()) && TextUtils.isEmpty(mail.getText().toString().trim()) && TextUtils.isEmpty(pass.getText().toString().trim())) {
                ...
                public void userdata(){
                    ...
                    _phn=phone.getText().toString().trim();
                    _mail=mail.getText().toString().trim();
                    _pass=pass.getText().toString().trim();
                    FirebaseDatabase firebaseDatabase=FirebaseDatabase.getInstance();
                    DatabaseReference register = firebaseDatabase.getReference().child("users").child("Parent").child(mAuth.getUid());
                    Parent reg = new Parent(_id,_name,_phn,_mail,_pass);
    ...
    private void Mymessage(){
        String phnno=phone.getText().toString().trim();
